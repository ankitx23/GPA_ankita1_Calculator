package com.example.gpa_ankita1_calculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ConstraintLayout backgroundLayout = findViewById(R.id.mainLayout); // Assuming your root layout has the id mainLayout
